...
export default function PerfilProf({ navigation }) {
    ...
    async function tela2() {
        navigation.navigate('EditarPro');
    }
    async function tela3() {
        ...
        <ImageBackground source={bgImage} style={styles.backgroundContainer}>
            <ScrollView style={{ flex: 1 }}>
                <View style={styles.TodoContainer}>
                    ...
                    <View><Text style={styles.logoText}>PROFESSOR</Text></View>

                    <View style={styles.inputContainer}>
                        <Text style={styles.titulos}>Nome do Professor</Text>
                    </View>
                    ...
                    <TouchableOpacity onPress={tela3} style={styles.btnReserva} >
                        <Text style={styles.text}>Reservar Lab</Text>
